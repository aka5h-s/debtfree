...
import { StyleSheet, Text, View, Pressable, TextInput, Alert, Platform, Dimensions, ScrollView, FlatList, NativeSyntheticEvent, NativeScrollEvent } from 'react-native';
